...
public class MysqlCurrentPlayerColorDao implements CurrentPlayerColorDao {
    ...
    public MysqlCurrentPlayerColorDao(final JdbcConnectionPool connectionPool) {
        this.connectionPool = connectionPool;
    }

    @Override
    public PieceColor findPlayerColor() {
    ...
    @Override
    public void savePlayerColor(final PieceColor playerColor) {
    ...
    @Override
    public void updatePlayerColor(final PieceColor changeColor) {
